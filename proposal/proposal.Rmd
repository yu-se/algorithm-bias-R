...
anno_wo_red <- within(anno_wo_red, annotator_sexuality[annotator_sexuality_bisexual == 'True']<-'atheist')
anno_wo_red <- within(anno_wo_red, annotator_sexuality[annotator_sexuality_gay == 'True']<-'buddhist')
anno_wo_red <- within(anno_wo_red, annotator_sexuality[annotator_sexuality_straight == 'True']<-'christian')
anno_wo_red <- within(anno_wo_red, annotator_sexuality[annotator_sexuality_other == 'True']<-'hindu')
```
